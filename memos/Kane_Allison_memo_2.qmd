...
# Overall Progress and Potential Issues

  Overall, this progress indicates that there is much to be done. The logistical regression was fitted relatively easily, however the random forest model took considerable time and caused substantial issues in the github and the operating system of my computer, even with parallel processing. Currently, I am exploring options to obtain a separate computer that has a more powerful processing capability, as the one I am currently using is about 5 years old. 
